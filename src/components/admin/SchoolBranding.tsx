  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate__animated animate__fadeIn">
      <div className="text-center space-y-4">
        <div className="w-20 h-20 bg-blue-600 rounded-[2rem] flex items-center justify-center text-white mx-auto shadow-2xl shadow-blue-200 rotate-12">
          <Settings size={40} />
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center bg-white p-12 rounded-[3rem] border border-slate-100 shadow-xl">
        {/* Current Identity */}
        <div className="space-y-8">
          <div className="space-y-4">
            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Active Logo</label>
            <div className="w-56 h-56 rounded-[3rem] bg-slate-50 border-4 border-white shadow-inner flex items-center justify-center overflow-hidden relative group">
              {logo ? (
        ...
        <div className="space-y-8">
          ...
          <div className="relative group">
            <input 
              ...
              accept="image/*"
            />
            <div className="p-10 border-4 border-dashed border-slate-100 rounded-[2.5rem] text-center group-hover:border-blue-300 transition-all bg-slate-50/30 group-hover:bg-blue-50/20">
          ...
          <div className="flex gap-4">
            <div className="flex-1 p-4 rounded-xl bg-slate-50 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center border border-slate-100">
              Auto-Sync Enabled
            </div>
            <div className="flex-1 p-4 rounded-xl bg-slate-50 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center border border-slate-100">
              Cloud Storage V2
