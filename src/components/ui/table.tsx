...
export const TableHead = ({ className, children }: any) => <th className={`h-12 px-4 text-left align-middle font-black text-muted-foreground [&:has([role=checkbox])]:pr-0 ${className}`}>{children}</th>;
