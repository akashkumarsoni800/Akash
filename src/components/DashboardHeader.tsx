...
const DashboardHeader = ({ full_name, avatarUrl, userRole, onMenuClick }: any) => {
 ...
 return (
  <header className="fixed top-0 right-0 left-0 lg:left-64 bg-white/80 backdrop-blur-3xl z-20 px-2 md:px-4 h-20 flex justify-between items-center border-b border-slate-100/50 no-print transition-all duration-300 font-inter">
