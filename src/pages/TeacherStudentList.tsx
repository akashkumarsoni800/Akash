  ...
  if (loading && !students.length) {
    return (
       <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center">
          ...
          <p className="font-medium   text-slate-400 text-[10px] mt-8 text-center px-10">Synchronizing Faculty Liaison...</p>
       </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-10">
           ...
           <div className="bg-white border border-slate-100 rounded-[3rem] p-8 shadow-sm flex items-center gap-10 group hover:shadow-xl transition-all relative z-20">
             ...
             <div>
                <p className="text-[10px] font-medium text-slate-400   mb-2 leading-none">Managed Cohort</p>
                <p className="text-4xl font-medium text-slate-900   leading-none">{students.length} Scholars</p>
             </div>
           </div>
        </div>
              ...
              >
                ...
                <div className="flex items-center gap-6 mb-10 relative z-10">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-emerald-500 font-medium text-[10px]  tracking-widest">{student.class_name}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-10 p-8 bg-slate-50/50 rounded-[2.5rem] border border-slate-50 group-hover:bg-white group-hover:border-emerald-50 transition-all duration-700 relative z-10">
                   <div className="space-y-2">
                      <p className="text-[9px] font-medium text-slate-400  tracking-widest leading-none">Presence Index</p>
                      <div className="flex items-end gap-2">
                         <p className="text-2xl font-medium text-slate-900  leading-none">{student.attendance_rate}%</p>
                         <Activity size={14} className={student.attendance_rate >= 85 ? 'text-emerald-500' : 'text-amber-500'} />
                      </div>
                   </div>
                   <div className="space-y-2">
                      <p className="text-[9px] font-medium text-slate-400  tracking-widest leading-none">Academic Yield</p>
                      <div className="flex items-end gap-2">
                         <p className="text-2xl font-medium text-slate-900  leading-none">{student.avg_marks}%</p>
                ...
                <div className="flex items-center justify-between relative z-10">
                   ...
                   <button className="flex items-center gap-3 bg-slate-900 text-white px-6 py-4 rounded-2xl font-medium  text-[9px] tracking-widest shadow-xl group-hover:bg-emerald-600 transition-all ">
        ...
        {filteredStudents.length === 0 && (
          <div className="py-48 flex flex-col items-center justify-center text-center opacity-20">
             ...
             <p className="font-medium   text-slate-400 text-sm">No Matching Scholar Records Indexed</p>
          </div>
        )}
