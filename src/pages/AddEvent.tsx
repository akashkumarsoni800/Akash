                ...
                <div className="grid gap-10">
                   ...
                   <div className="space-y-4">
                      ...
                      <input
                        type="date"
                        required
                        className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] px-8 py-5 text-lg font-bold text-slate-900 outline-none focus:ring-4 focus:ring-blue-100 focus:bg-white transition-all shadow-inner "
