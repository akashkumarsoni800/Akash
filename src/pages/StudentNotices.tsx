...
const StudentNotices = () => {
  ...
  if (loading) return (
    <div className="h-screen flex flex-col items-center justify-center bg-slate-50">
       ...
       <p className="font-black uppercase tracking-[0.4em] text-slate-400 italic text-[10px] mt-8">Syncing Bulletin Feed...</p>
    </div>
  );
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-3 bg-white px-6 py-3 rounded-2xl border border-slate-100 shadow-sm">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 italic ">Priority Broadcast Channel</span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-10">
           ...
           <div className="bg-white border border-slate-100 rounded-[2.5rem] p-6 shadow-sm flex items-center gap-8 group hover:shadow-xl transition-all">
             ...
             <div>
               <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Active Broadcasts</p>
               <p className="text-3xl font-black text-slate-900 tracking-tighter italic ">{notices.length} Updates</p>
             </div>
           </div>
        </div>
              ...
              >
                 ...
                 <div className="relative z-10 space-y-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                       <div className="flex items-center gap-6">
                          ...
                          <div className="space-y-1">
                             <h3 className="text-2xl md:text-4xl font-black text-slate-900 uppercase tracking-tighter italic  leading-none">{notice.title}</h3>
                    ...
                    <div className="relative">
                       ...
                       <p className="text-slate-600 font-medium text-lg md:text-xl leading-relaxed pl-12 border-l-[6px] border-blue-50 italic py-4 group-hover:border-blue-200 transition-colors">
                          {notice.description}
                       </p>
                    </div>
                    ...
                    <div className="pt-6 flex items-center gap-4">
                       ...
                       <span className="text-[9px] font-black text-slate-300 uppercase tracking-[0.4em]">End of Transmission</span>
                    </div>
                 </div>
              </motion.div>
            ))}
          ...
          {notices.length === 0 && (
            ...
            >
               ...
               <div className="space-y-4">
                  <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tighter italic ">Manifest Locked</h3>
