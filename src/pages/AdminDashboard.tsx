...
const AdminDashboard = () => {
  ...
  if (loading && !counts.students) return <div className="h-screen flex items-center justify-center font-black text-slate-400 tracking-[0.4em] uppercase text-xs">ASM SYNCING...</div>;
