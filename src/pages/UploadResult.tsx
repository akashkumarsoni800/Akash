...
const UploadResult = () => {
  ...
  const handleExamChange = (examId) => {
    ...
    // ✅ Crash Fix: Check if exam and subjects exist, use exam.subjects.length
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-black text-gray-900 tracking-tighter uppercase">Result Center</h1>
        </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest ml-2">Step 2: Choose Exam</label>
                  <div className="relative">
                    <select 
                      required
                      ...
                      style={{ color: '#1e3a8a' }} // Forced deep blue color
                      value={selectedExam}
                ...
                {selectedStudent && (
                  <div className="bg-emerald-50 p-4 rounded-2xl flex items-center gap-4 border border-emerald-100 self-end animate-in fade-in zoom-in">
                    ...
                    <div>
                      ...
                      <p className="text-[8px] font-bold text-emerald-500 mt-1 uppercase">Selection Valid</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              >
                {loading ? 'PROCESSING...' : 'CONFIRM & PUBLISH RESULT'}
              </button>
            </form>
          </div>
        </div>
